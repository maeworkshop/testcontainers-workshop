...
//        input.send(new GenericMessage<>("hello world"), "new-order-message");
//
//        Awaitility.await().atMost(10, TimeUnit.SECONDS);
//        final boolean customerExists = customerOrderRepository.findAll().stream()
...
//                (NewOrderMessageDto.newBuilder()
//                        .setCustomerId(CUSTOMER_ID_2)
//                        .setOrderNo(ORDER_NO_2)
//                        .setProductName(PRODUCT_NAME_2)
//                        .build());
